...
function model(sequelize) {
    const attributes = {
        ...
        scrapTypeId: { type: DataTypes.STRING, allowNull: false },
        impurity: { type: DataTypes.STRING },
        sourceMasterId: { type: DataTypes.STRING, allowNull: false },
        loadPortOriginId: { type: DataTypes.STRING, allowNull: false },
